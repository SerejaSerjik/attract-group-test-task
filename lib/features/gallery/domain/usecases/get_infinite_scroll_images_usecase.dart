...
@LazySingleton()
class GetInfiniteScrollImagesUseCase {
  final ImageRepository repository;

  GetInfiniteScrollImagesUseCase(this.repository);

  Future<Either<Failure, List<ImageEntity>>> call({int page = 1, int limit = 30}) async {
    return await repository.getInfiniteScrollImages(page: page, limit: limit);
  }
}
